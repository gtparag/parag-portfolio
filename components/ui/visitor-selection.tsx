  ...
  return (
    ...
    >
      <div className="max-w-2xl w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {visitorOptions.map((option, index) => (
            <motion.button
              ...
              className="group p-6 border border-gray-700 rounded-lg bg-gray-900/50 hover:bg-gray-800/80 hover:border-gray-500 transition-all duration-300 text-left"
            >
              <div className="flex items-start gap-4">
                <div className="p-3 rounded-lg bg-gray-800 group-hover:bg-gray-700 transition-colors">
                  <option.icon className="w-6 h-6 text-gray-300 group-hover:text-white transition-colors" />
                </div>
                <div>
        ...
        >
          Your selection customizes the viewing experience
        </motion.p>
      </div>
    </motion.div>
  );
